...
class AboutUs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ResponsiveWidget(
        largeScreen: fullscreenAboutUs(context, size, txtstyle),
        mediumScreen: halfscreenAboutUs(context, size, txtstyle),
      ),
    );
  }

  // full screen about us ............................

  Widget fullscreenAboutUs(
      BuildContext context, Size size, TextStyle txtstyle) {
    return Stack(
      children: [
        Row(
          children: [
  ...
  // half screen about us ................
  Widget halfscreenAboutUs(
      BuildContext context, Size size, TextStyle txtstyle) {
    return Stack(
      children: [
        Row(
